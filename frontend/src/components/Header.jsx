...
const users = [
  ...
  { name: 'Hospital Login', description: 'Upload patient\'s reports & bills', to: '/hospital/login', icon: faHospital },
  { name: 'Insurance Company Login', description: 'Always ready to save your customers life', to: '/insurance/login', icon: faHeartCircleCheck }
]
const callsToAction = [
