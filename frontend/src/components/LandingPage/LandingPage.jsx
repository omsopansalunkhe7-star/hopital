    ...
    return (
        ...
        items-center min-h-screen">
                        <div className="h-full absolute top-0 left-0 z-0">
                            <img src="images/cover-bg.jpg" alt="Medical Background" className="w-full h-full object-cover opacity-20" />
                        </div>
                        <div className="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
                            <div>
                                ...
                                <p className="text-blue-100 text-left text-xl md:text-2xl leading-snug mt-4">Experience a new level of convenience and control over your healthcare with our HEALTH CARE RECOARD 
MANAGEMENT AND INSURANCE CLAIM.</p>
                ...
                <h1 className="text-3xl text-center pt-0 lg:py-12 leading-tight font-bold mt-4">Features</h1>
                    <div className="flex flex-col lg:flex-row lg:-mx-8">
                        <div className="w-full lg:w-1/2 lg:px-8">
                            <h2 className="text-2xl leading-tight font-bold mt-4">Welcome to our HEALTH CARE RECOARD 
MANAGEMENT AND INSURANCE CLAIM</h2>
                        ...
                        <div className="w-full lg:w-1/2 lg:px-8 mt-12 lg:mt-0">
                            ...
                            <div className="md:flex mt-8">
                                ...
                                <div className="md:ml-8 mt-4 md:mt-0">
                                    ...
                                    <p className="mt-2 leading-relaxed">Whether you're managing a chronic condition, preparing for a routine check-up, or just looking to stay on top of your health, our HEALTH CARE RECOARD 
MANAGEMENT AND INSURANCE CLAIM is here to help. Sign up today to start taking control of your health!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="md:flex md:flex-wrap mt-24 text-center md:-mx-4">
                        <div className="md:w-1/2 md:px-4 mt-4 md:mt-0 lg:w-1/3">
                            <div className="bg-white rounded-lg border border-gray-300 p-8">
                                <img src="images/appointments.svg" alt="Calendar Icon" className="h-20 mx-auto" />
                        ...
                        <div className="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/3">
                            <div className="bg-white rounded-lg border border-gray-300 p-8">
                                <img src="images/messaging.svg" alt="Messaging Icon" className="h-20 mx-auto" />
                        ...
                        <div className="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/3">
                            <div className="bg-white rounded-lg border border-gray-300 p-8">
                                <img src="images/records.svg" alt="Medical Records Icon" className="h-20 mx-auto" />
                ...
                <section className="relative bg-blue-teal-gradient px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 text-center md:text-left">
                    <div className="md:flex md:items-center md:justify-center">
                        <h2 className="text-xl font-bold text-white">Get in touch with us today! <br className="block md:hidden" />Call us on: +91-8010383026</h2>
                ...
                <footer className="relative text-left bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
                    <div className="flex flex-col md:flex-row">
                        <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
                            <h3 className="font-bold text-2xl">HEALTH CARE RECOARD 
MANAGEMENT AND INSURANCE CLAIM</h3>
                            <p className="text-gray-400">Revolutionize your healthcare experience with our cutting-edge HEALTH CARE RECOARD 
MANAGEMENT AND INSURANCE CLAIM.</p>
                            <form className="flex items-center mt-6">
                                <div className="w-full">
                                    <label className="block uppercase tracking-wide text-gray-600 text-xs font-bold mb-2" htmlFor="newsletter-email">
                                        Subscribe for our Newsletter
                                    </label>
                                    <div className="relative">
                                        <input id="newsletter-email" className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-4 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="email" placeholder="Enter Your Email Address" />
                        ...
                        <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                            ...
                            <ul className="mt-4">
                                <li className="mt-2"><button className="opacity-75 hover:opacity-100 text-left bg-transparent border-none p-0">General Medicine</button></li>
                                <li className="mt-2"><button className="opacity-75 hover:opacity-100 text-left bg-transparent border-none p-0">Dermatologists</button></li>
                                <li className="mt-2"><button className="opacity-75 hover:opacity-100 text-left bg-transparent border-none p-0">Cardiologistsh</button></li>
                                <li className="mt-2"><button className="opacity-75 hover:opacity-100 text-left bg-transparent border-none p-0">Gynaecologist</button></li>
                            </ul>
                        </div>
                            ...
                            <ul className="mt-4">
                                <li>
                                    <div className="block flex items-center opacity-75 hover:opacity-100">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" className="fill-current" aria-hidden="true">
                                                <path d="M12,2C7.589,2,4,5.589,4,9.995C3.971,16.44,11.696,21.784,12,22c0,0,8.029-5.56,8-12C20,5.589,16.411,2,12,2z M12,14 c-2.21,0-4-1.79-4-4s1.79-4,4-4s4,1.79,4,4S14.21,14,12,14z" />
                                            </svg>
                                        </span>
                                        <span className="ml-3">
                                        Neral, Maharashtra , India
                                        </span>
                                    </div>
                                </li>
                                <li className="mt-4">
                        ...
                        <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                            ...
                            <ul className="mt-4 flex">
                                <li>
                                    <a href="https://www.facebook.com/omsalunkhe/" target="_blank" rel="noopener noreferrer" title="Facebook">
                                ...
                                <li className="ml-6">
                                    <a href="https://www.instagram.com/om_salunkhe96/" target="_blank" rel="noopener noreferrer" title="Instagram">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" className="fill-current">
                                ...
                                <li className="ml-6">
                                    <a href="https://www.youtube.com/omsalunkhe96/" target="_blank" rel="noopener noreferrer" title="YouTube">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" className="fill-current">
                            ...
                            <p className="text-sm text-gray-400 mt-12">© 2025 HEALTH CARE RECOARD 
MANAGEMENT AND INSURANCE CLAIM. <br className="hidden lg:block" />.
                            </p>
                        </div>
                    </div>
                </footer>
